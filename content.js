...
(function (global) {
  ...
  ABW.content = {
    ...
    /* ---- 霸凌是什麼樣子（2026-09-02 資料化）----
     * ⛔ 內容改由資料驅動，後台才改得動（原本寫死在 cases.html）。
     * 粗體寫成 **這樣**，由 js/pages.js 建成 DOM 節點——⛔ 不吃 HTML。 */
    cases: {
          "items": [
                {
                      "id": "c1",
                      ...
                      "fields": [
                            {
                                  "q": "發生了什麼",
                                  "a": "班上原本的群組多了一個新的，成員是全班減一。分組報告在新群組裡分完，他到當天早上才知道自己沒有組。之後兩個月，午餐、掃地、校外教學的分工都是這樣決定的。沒有人罵他，也沒有人動他。"
                            },
                            {
                                  "q": "當下有誰在場",
                                  "a": "三十個人。其中大約五個人主動維持這件事，其餘的人知道、覺得不太對，但沒有退出那個群組——因為退出的人就會變成下一個。"
                            },
                            {
                                  "q": "事後怎麼處理",
                                  "a": "導師知道以後，在班上說「大家要合作」，然後重新分組一次。分組表是老師排的，那一節課結束後，新群組還在。"
                            },
                            {
                                  "q": "如果換一個做法",
                                  "a": "「叫大家對他好一點」把責任丟回給三十個人，等於沒有人負責。準則第 38 條寫的是**減少雙方互動機會**、必要時**抽離或個別教學**，而且要**尊重被行為人的意願**——先問他想要什麼，而不是先要求全班改變態度。同時，維持這件事的那五個人是可辨識的具體行為人，不是「班上的氣氛」。"
                            }
                      ]
                },
                {
                      ...
                      "fields": [
                            {
                                  "q": "發生了什麼",
                                  "a": "他的照片被做成梗圖，配上一句嘲笑他家庭狀況的字，貼在公開帳號上。兩天內兩百多個讚，留言裡有人接著編下一個版本。他認識裡面大部分的人。"
                            },
                            {
                                  "q": "當下有誰在場",
                                  "a": "沒有「當下」。這是網路霸凌最難處理的地方——它沒有一個結束的時間點，也沒有一個可以離開的空間。他刪掉自己的帳號，梗圖還在。"
                            },
                            {
                                  "q": "事後怎麼處理",
                                  "a": "學校請發文的同學把貼文刪掉，他也刪了。但轉發的版本散在十幾個地方，沒有人數得完，也沒有人負責去數。"
                            },
                            {
                                  "q": "如果換一個做法",
                                  "a": "先固定證據再要求刪除：截圖要含網址、時間、帳號，這是後面所有程序的基礎。刪文之後證據就沒了，這是實務上最常見的順序錯誤。同時準則第 4 條明文把**電子通訊、網際網路**列為霸凌方式，校外發生也算——「那是他們私下在網路上做的」不是免責理由。"
                            }
                      ]
                },
                {
                      ...
                      "fields": [
                            {
                                  "q": "發生了什麼",
                                  "a": "三個學長在放學後的樓梯間跟他「借」錢，一次五十到一百。不給就推、擋著不讓走。他後來每天只帶剛好的錢，這樣被拿走的時候比較不痛。持續大半個學期。"
                            },
                            {
                                  "q": "當下有誰在場",
                                  "a": "樓梯間沒有監視器，這是他們選那裡的原因。有兩次有其他學生經過，加快腳步走掉了。"
                            },
                            {
                                  "q": "事後怎麼處理",
                                  "a": "家長發現錢不見去學校反映。學校找三人來談，三人說是借的、會還。事情就到這裡。"
                            },
                            {
                                  "q": "如果換一個做法",
                                  "a": "「說是借的」不改變行為的性質。這裡有兩件事該分開：校內程序（依準則檢舉、20 個工作日內書面回覆是否受理、處理小組過半外聘）與刑事責任（那是警方與少年法院的事，不是學校談一談能結案的）。學校把它當成同學間的金錢糾紛處理，等於把一件需要循正式程序處理的事降級成誤會。"
                            }
                      ]
                },
                {
                      ...
                      "fields": [
                            {
                                  "q": "發生了什麼",
                                  "a": "每次考完，老師都會在全班面前念他的分數，加一句「這樣以後要做什麼」。一整個學年，每次段考。他開始在考前一週睡不著。"
                            },
                            {
                                  "q": "當下有誰在場",
                                  "a": "全班。有同學覺得過分，但那是老師。"
                            ...
                            {
                                  "q": "事後怎麼處理",
                                  "a": "家長反映後，學校說老師是「求好心切、方式比較直接」，請老師注意用詞。下次段考照念。"
                            },
                            {
                                  "q": "如果換一個做法",
                                  "a": "113 年修正的準則**把「師對生霸凌」明確列為一種類型**，處理程序與生對生不同，不是靠導師之間協調或「請老師注意」就算處理過。這一類最容易被降級成「教學風格」，而它恰恰是權力最不對等的那一種。"
                            }
                      ]
                }
          ]
    ...
    /* ---- 你該知道的三件事（2026-09-02 資料化）----
     * ⛔ 區塊型別是具名的，未知型別不渲染。法規原文改動前先看
     *    memory feedback_legal_content_needs_review：引用原文安全，
     *    解釋與涵攝要律師簽核（law.signedOff 仍為 false）。 */
    lawPage: {
          "sections": [
                {
                      "id": "s-def",
                      ...
                      "blocks": [
                            {
                                  "type": "quote",
                                  "text": "個人或集體**持續**以言語、文字、圖畫、符號、肢體動作、電子通訊、網際網路或其他方式，直接或間接對他人**故意**為貶抑、排擠、欺負、騷擾或戲弄等行為，使他人處於具有敵意或不友善環境，產生精神上、生理上或財產上之損害。",
                                  "cite": "校園霸凌防制準則第 4 條"
                            },
                            {
                                  "type": "para",
                                  "text": "同一條另外把霸凌分成兩種：**生對生霸凌**指學生之間、 **師對生霸凌**指教職員工對學生，兩者發生在校園內外都算，處理程序不同。"
                            }
                      ]
                },
                {
                      ...
                      "blocks": [
                            {
                                  ...
                                  "items": [
                                        {
                                              "title": "提出檢舉（第 18 條）",
                                              "text": "被行為人、法定代理人、實際照顧者，或任何知道這件事的人都可以檢舉。要填檢舉書，載明檢舉人姓名、聯絡電話、日期，以及被行為人的學校班級、事實內容與證據。當面口頭檢舉時，學校應協助填寫。"
                                        },
                                        {
                                              "title": "20 個工作日內書面回覆（第 25 條）",
                                              "text": "學校應於接獲檢舉之日起 20 個工作日內，以書面通知檢舉人是否受理。"
                                        },
                                        {
                                              "title": "處理小組過半外聘（第 27 條）",
                                              "text": "小組以 3 人或 5 人為原則；一般學校至少過半數委員應自人才庫外聘，偏遠地區學校至少三分之一。"
                                        },
                                        {
                                              "title": "2 個月內完成調查（第 43 條）",
                                              "text": "自召開第一次調和或調查會議之日起 2 個月內完成報告；必要時得延長，延長以二次為限，每次不得逾 1 個月。"
                                        },
                                        {
                                              "title": "15 個工作日內終局處理（第 46 條）",
                                              "text": "學校應於決議之日起 15 個工作日內作成終局實體處理，並於 10 個工作日內以書面載明事實及理由通知雙方。"
                                        }
                                  ]
                            },
                            {
                                  "type": "para",
                                  "text": "準則對學校的每一個動作都訂了期限。你不必猜他們在拖，可以直接對照條號。"
                            },
                            {
                                  "type": "note",
                                  "text": "若檢舉的學校不是被行為人就讀的學校，應於 **3 個工作日內**移送（第 19 條）。"
                            }
                      ]
                },
                {
                      ...
                      "blocks": [
                            {
                                  ...
                                  "items": [
                                        ...
                                        "尊重被行為人之意願，減低當事人雙方互動之機會；必要時得對當事人施予抽離或個別教學、輔導。",
                                        "暫時將當事人安置到其他班級，或協助當事人依法定程序轉班。",
                                        "提供心理諮商與輔導、班級輔導或其他協助，必要時得訂定輔導計畫。",
                                        "避免行為人及其他關係人之報復情事。"
                                  ]
                            },
                            {
                                  "type": "para",
                                  "text": "以下是準則第 38 條列出的項目："
                            },
                            {
                                  "type": "para",
                                  "text": "準則另規定，學校於處理或輔導程序中得採取創傷知情之態度，並得善用修復式正義（第 8 條、第 28 條）。 準則所稱「調和」，以行為人、被行為人及其法定代理人**均同意**為前提（第 4 條第 8 款）。"
                            }
                      ]
                },
                {
                      ...
                      "blocks": [
                            {
                                  ...
                                  "items": [
                                        {
                                              "num": "1953",
                                              "text": "**教育部反霸凌專線**／24 小時。不確定算不算霸凌也可以打，這就是它存在的用途。",
                                              "url": ""
                                        },
                                        {
                                              "num": "1925",
                                              "text": "**衛福部安心專線**／24 小時免付費。撐不住的時候先打這支。",
                                              "url": ""
                                        },
                                        {
                                              "num": "1995",
                                        ...
                                        {
                                              "num": "法扶",
                                              "text": "**法律扶助基金會**／符合資格可申請免費律師。",
                                              "url": "https://www.laf.org.tw/"
                                        },
                                        {
                                              "num": "學校",
                                              "text": "向學校提出檢舉，走上面第二段的法定程序。",
                                              "url": ""
                                        }
                                  ]
                            },
                            {
                                  "type": "note",
                                  "text": "你不需要先準備好所有證據才開口。上面每一支專線都可以在「我還不確定」的狀態下打。"
                            }
                      ],
                      "bleed": true
                },
                                  ...
                                  "items": [
                                        {
                                              ...
                                              "note": "（全國法規資料庫，113 年 4 月 17 日修正）"
                                        },
                                        {
                                              "label": "教育部防制校園霸凌專區",
                                              "url": "https://bully.moe.edu.tw/index"
                                        }
                                  ]
                            }
                      ]
