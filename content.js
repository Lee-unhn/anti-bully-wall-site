...
(function (global) {
  ...
  ABW.content = {
    ...
    /* ---- 牆 ---- */
    wall: {
      composePrompt: '想說什麼都可以。送出後會先經過人工檢視，通過才會出現在牆上。',
      composePlaceholder: '那天發生的事是……',
      maxLength: 300,
      pendingNotice: '已經收到你的話了。它會先經過人工檢視，通過之後就會出現在牆上，然後你會開始收到別人給你的溫暖。',
      /* ⛔ 資料層是本機時要用這一句，不能用上面那句。
       * 上面那句承諾「會出現在牆上、會收到別人的溫暖」——本機模式下
